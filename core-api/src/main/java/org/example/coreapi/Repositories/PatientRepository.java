...
public interface PatientRepository extends JpaRepository<Patient,Long > {
    ...
    void updatePatientDetails( Long id,String email, String phone, int age, String address, String password, double height, double weight ,String bloodGroup, String document_url);
